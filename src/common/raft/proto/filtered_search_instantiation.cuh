...
using index_instantiation = std::conditional_t<
  K == raft_proto::raft_index_kind::ivf_flat,
  raft::neighbors::ivf_flat::index<T, IdxT>,
  std::conditional_t<
    K == raft_proto::raft_index_kind::ivf_pq,
    raft::neighbors::ivf_pq::index<IdxT>,
    std::conditional_t<
      K == raft_proto::raft_index_kind::cagra,
...
template void search_with_filtering<T, IdxT, raft::neighbors::filtering::bitset_filter<BitsetDataT, BitsetIdxT>>( \
  ...
  raft::device_matrix_view<const T, InpIdxT>, \
  raft::device_matrix_view<IdxT, InpIdxT>, \
  raft::device_matrix_view<DistT, InpIdxT>, \
  raft::neighbors::filtering::bitset_filter<BitsetDataT, BitsetIdxT> \
)

#define RAFT_FILTERED_SEARCH_INSTANTIATION(index_type, T, IdxT, InpIdxT, DistT, BitsetDataT, BitsetIdxT) namespace raft::neighbors::index_type { \
RAFT_FILTERED_SEARCH_TEMPLATE(index_type, T, IdxT, InpIdxT, DistT, BitsetDataT, BitsetIdxT); \
}

#define RAFT_FILTERED_SEARCH_EXTERN(index_type, T, IdxT, InpIdxT, DistT, BitsetDataT, BitsetIdxT) namespace raft::neighbors::index_type { \
RAFT_FILTERED_SEARCH_TEMPLATE(index_type, T, IdxT, InpIdxT, DistT, BitsetDataT, BitsetIdxT); \
}
